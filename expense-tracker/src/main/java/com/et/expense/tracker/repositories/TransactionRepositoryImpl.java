...
public class TransactionRepositoryImpl implements TransactionRepository {
    ...
    public Transaction findById(Integer userId, Integer categoryId, Integer transactionId) throws EtResourceNotFoundException {
        try{
            ...
            throw new EtBadRequestException("Requested Transaction not found");
        }
    }

    @Override
    public Integer create(Integer userId, Integer categoryId, Double amount, String note, Long transactionDate) throws EtResourceNotFoundException {
        try {

...
import com.et.expense.tracker.repositories.TransactionRepository;
...
public class TransactionServiceImpl implements TransactionService {
    ...
    @Override
    public Transaction fetchTransactionById(Integer userId, Integer categoryId, Integer tranactionId) throws EtResourceNotFoundException {
